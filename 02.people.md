...
| ? | Champ starts | ? |
| Toni Brown | Carnival starts | MIDDLE, SPRINT, LONG |
| ? | Carnival starts | ? |
| ? | Carnival starts | ? |
...
We need 4 more volunteers to fill the `start team` roles in each event (warm-up, mass, middle, sprint, long).
:::
...
We need 4 more volunteers to be traffic marshals in the `parking team` on Friday and Saturday morning.
And probably three more people for the very special role of gate keeping at the Kowen forest on Sunday.
:::
...
| Hind Needham | Supervisor | Friday, Saturday morning |
| ? | Supervisor | Saturday afternoon |
| ? | Supervisor | Sunday |

:::{admonition} Call for volunteers
:class: danger

We need lovely volunteers to work at the kids tent on Saturday afternoon and Sunday.
:::
...
We need 9 more helpers to collect controls after the events.  Please, see the table below to see at which events you can contribute.
:::
